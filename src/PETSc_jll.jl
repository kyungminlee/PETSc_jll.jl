...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PETSc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("8fa3689e-f0b9-5420-9873-adf6ccf46f2d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PETSc", artifacts_toml) for e in artifacts["PETSc"]]
...
if best_platform === nothing
    @debug("Unable to load PETSc; unsupported platform $(triplet(platform_key_abi()))")
else
